...
EXP NO:5 A PROGRAM TO CREATE A FUNCTION TO FIND THE GREATEST NUMBER
Aim:
...
EXP NO:5 B PROGRAM TO PRINT THE MAXIMUM VALUES FOR THE AND, OR AND  XOR COMPARISONS
Aim:
...
EXP NO:5 C PROGRAM TO WRITE THE LOGIC FOR THE REQUESTS
Aim:
...
EXP NO:5 D PROGRAM PRINT THE SUM OF THE INTEGERS IN THE ARRAY.
Aim:
...
EXP NO 5 E PROGRAM TO COUNT THE NUMBER OF WORDS IN A      SENTENCE
